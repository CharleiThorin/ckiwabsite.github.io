   ...
   // "use strict";
    ...
    function boldText() {
        if (document.getElementById("bling").checked == true) {
            ...
            document.getElementById("textarea").style.color = "#70d18c";
            document.getElementById("textarea").style.textDecoration = "underline";
            document.body.style.backgroundImage = 'url("https://charleithorin.github.io/ckiwabsite.github.io/aboutme.html")';
        } else {
